...
/**
 * Represents a connection between two [Station] entities.
 */
class Route(
    val distance: Int,
) {
    ...
    /**
     * Observed by [Station], will emit [Person] entities when those entities complete traveling and arrive at
     * the destination.
     */
